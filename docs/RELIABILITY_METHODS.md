...
- Optional random survival forest: aggregate held-out Harrell and IPCW/Uno concordance indices,
  integrated Brier score, and observed-failure median-lifetime MAE. It uses only baseline temperature
  and initial RDS(on) features, and estimates individual risk within observed stress conditions; it
